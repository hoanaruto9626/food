                ...
                <div className="content_half float_l">
                    ...
                    <div id="contact_form">
                        <form method="post" name="contact" action="#">
                            ...
                            <label for="email">Email:</label> <input type="text" id="email" name="email" className="validate-email required input_field" />
                            <div className="cleaner h10"></div>
                            
                            <label for="phone">Phone:</label> <input type="text" name="phone" id="phone" className="input_field" />
                            <div className="cleaner h10"></div>
            
                            <label for="text">Message:</label> <textarea id="text" name="text" rows="0" cols="0" className="required"></textarea>
                            <div className="cleaner h10"></div>
                            
                            <input type="submit" className="submit_btn" name="submit" id="submit" value="Send" />
